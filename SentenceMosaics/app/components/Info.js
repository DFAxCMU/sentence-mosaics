...
The purpose of this app is to assist students in their formulation of novel, complete, and meaningful spoken sentences produced in context with a photograph or illustration and with a language “coach” (speech-language therapist, teacher, parent, tutor, etc.) to assist in facilitating correct syntax.  Students who can profit from the app include those with delayed language development (particularly with delayed oral expressive language skills), those whose hearing loss has impacted language skills, those for whom English is a second language, and those for whom written expression and/or reading is a challenge.   The program may be of benefit as well to adults who have suffered language loss secondary to head trauma or CVA.  
...
<Text style={{ fontSize: 30 }}> 
  Additional notes regarding application:
</Text>
...
Program designers through Design for America: Heidi (Jackie) Kang, Christie Chang, Ashley Lai, Elizabeth Board, Ambika Chetal, Mehar Sawhney, Eddie Dryer, Sashank Gogula, and Jennifer Chou at Carnegie Mellon University, Pittsburgh, PA.
